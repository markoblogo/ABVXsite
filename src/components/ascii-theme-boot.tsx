...
const ASCII_CSS_SRC = 'https://cdn.jsdelivr.net/gh/markoblogo/AsciiTheme@892c0ee/dist/style.css';
const ASCII_JS_SRC = 'https://cdn.jsdelivr.net/gh/markoblogo/AsciiTheme@892c0ee/dist/ascii-theme.umd.js';
...
function initAsciiTheme(): void {
  ...
  if (document.documentElement.dataset.asciiThemeInit === '1') {
    return;
  }
